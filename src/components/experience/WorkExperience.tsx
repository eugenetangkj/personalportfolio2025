...
export default function WorkExperience() {
    return (
            <section className='flex flex-col space-y-8'>
                {/* Title */}
                <h3 className='text-3xl md:text-4xl lg:text-5xl text-portfolioblack font-semibold text-left'>My Past Work Experience</h3>
                                ...
                                <div className='flex flex-row gap-4 items-center flex-wrap'>
                                    {
                                        workExperience.resources.map((resource, index) => (
                                            <Link href={ resource.link } key={ index } className='flex flex-row items-center gap-x-2 text-portfolioblack hover:text-zinc-400 duration-200'>
                                                <LinkIcon className='w-4 h-4' />{ resource.label }
                                            </Link>
                                        ))
                                    }
                                </div>
