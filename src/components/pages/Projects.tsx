...
import { AdditionalProjectsList, ProjectsList,  } from "@/constants/ProjectConstants";
...
export default function Projects() {
    return (
        <section className='flex flex-col gap-y-8 self-start scroll-mt-24' id='projects'>
            ...
            {/* Other Projects */}
            <div className='grid grid-cols-1 sm:grid-cols-2 sm:gap-x-16 gap-y-16'>
                {
                    AdditionalProjectsList.map((project, index) => (
                            <div className='flex flex-col gap-y-8 items-center gap-x-16' key={index}>
                                {/* Image */}
                                <Image src={ project.image } className='rounded-lg md:rounded-xl w-full' alt={ project.title } width={ 1920 } height={ 1080 } />
